...
class SliderDawer extends StatefulWidget {
  const SliderDawer({Key? key}) : super(key: key);

  @override
  SliderDawerState createState() => SliderDawerState();
}

class SliderDawerState extends State<SliderDawer> {
