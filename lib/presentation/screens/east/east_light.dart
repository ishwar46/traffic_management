...
class EastLight extends StatefulWidget {
  @override
  _EastLightState createState() => _EastLightState();
}

class _EastLightState extends State<EastLight> {
  ...
  int _timerDuration = 12;

  @override
  void initState() {
    super.initState();
    _database.child('eastlight').onValue.listen((event) {
