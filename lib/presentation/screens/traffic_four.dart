...
class TrafficLight_Four extends StatefulWidget {
  @override
  _TrafficLight_FourState createState() => _TrafficLight_FourState();
}

class _TrafficLight_FourState extends State<TrafficLight_Four>
    with AutomaticKeepAliveClientMixin<TrafficLight_Four> {
